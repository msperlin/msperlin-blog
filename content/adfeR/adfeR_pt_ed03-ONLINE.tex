...
O diferencial do pacote \texttt{writexl} em relação a \texttt{xlsx} é a não necessidade do Java, e a rapidez de execução. O lado negativo é que, na versão atual (1.4.0 -- 2022-08-10), não permite a escrita em arquivos já existentes. Veja a seguir: \index{writexl!write\_xlsx}
...
\NormalTok{library(BatchGetSymbols)}

\NormalTok{ticker \textless{}{-} \textquotesingle{}\^{}GSPC\textquotesingle{}}
\NormalTok{df\_prices \textless{}{-} BatchGetSymbols(tickers = ticker, }
\NormalTok{                             first.date = \textquotesingle{}2010{-}01{-}01\textquotesingle{})[[2]]}

\NormalTok{my\_arima \textless{}{-} auto.arima(df\_prices$ret.adjusted.prices)}
\NormalTok{summary(my\_arima)}
\end{Highlighting}
\end{Shaded}
