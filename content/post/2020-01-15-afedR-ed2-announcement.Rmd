...
- Dynamic 90+ exercises with the [`exams` package](http://www.r-exams.org/). This means you can create and grade randomized unique tests for your students (see this [post](https://www.msperlin.com/blog/post/2019-12-02-dynamic-exercises-afedr/) for details);

Book package `afedR`
: - This package makes it easier to import book datasets, slides, functions and solutions for end-of-chapter exercises. Available in [GitHub](https://github.com/msperlin/afedR) only. See this [blog post](https://www.msperlin.com/blog/post/2020-02-25-afedr-ed2-slides-available/) for instructions on installation.
