...
Research wise, my scientometrics paper [Is predatory publishing a real threat? Evidence from a large database study](https://www.msperlin.com/blog/publication/2018_scientometrics-predatory/) was featured in many [news outlets](https://www.msperlin.com/blog/research/on-the-news/). Its [altmetric page](https://springeropen.altmetric.com/details/38773966) is doing great, with over 1100 downloads and featured at top 5% of **all** research output measured by altmetric. This is, by far, the most impactful research piece I ever wrote. Its rewarding to see my work featured in the local and international media.

This year I also released the first version of [GetDFPData](https://www.msperlin.com/blog/post/2017-12-06-package-getdfpdata/), a R package for accessing a large database of financial information from B3, the Brazilian exchange. I'm glad to report that many people are using it for their own research. I can see the number of visits in the web interface and the frequent emails I get about the package. The feedback from other researchers has been great but, off course, there are always ways to improve the code. I've been constantly developing it over time. 
...
In november I changed the technology behind my blog from [Jekyll to Hugo](https://www.msperlin.com/blog/post/2018-11-03-newblog/). Can't stress enough how much I'm liking the Academic template built with blogdown and hosted in my own server. It is far easier to write posts and maintain the website.
