...
In november I changed the technology behind my blog from [Jekyll to Hugo](https://www.msperlin.com/post/2018-11-03-newblog/). Can't stress enough how much I'm liking the Academic template built with blogdown and hosted in my own server. It is far easier to write posts and maintain the website.
