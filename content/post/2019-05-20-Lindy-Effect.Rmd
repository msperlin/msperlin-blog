...
From the investment point of view, **the results suggests that time is a friend of the investor**. Overall, companies tend to improve its earnings. This corroborates the results from a [previous post](https://www.msperlin.com/blog/post/2018-05-12-investing-long-run/), where I analyzed the effect of the investment holding period over nominal and real returns to the investor. In short, the more time you stay in the market, the better. 
