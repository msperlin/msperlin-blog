...
```{r, include=FALSE}
my.file.location <- '~/Dropbox/11-My Website/www.msperlin.com-blog/content/post/2018-11-03-RstudioTricks.Rmd'
```
...
![](/blog/img/rstudio-whitetheme.png) ![](/blog/img/rstudio-darktheme.png)
...
![Autocomplete for files](/blog/img/autocomplete_arquivos.png) 

![Autocomplete for packages](/blog/img/autocomplete_pacotes.png) 
