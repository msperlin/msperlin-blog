...
2020-07-18: Package GetCVMData is now named GetDFPData2. See [this post](https://www.msperlin.com/blog/post/2020-07-18-new_packages-getfredata-getdfpdata2/) for details. The old code in `GetCVMData` is still in Github but will no longer be developed.
```
